...
interface onElinksEventDescriptor extends PropertyDescriptor {
...
export const decoratorFactoryFn = ({
  ...
  return (
    target: object,
    key?: any,
    descriptor?: onElinksEventDescriptor
  ): onElinksEventDescriptor => {
...
export const OnElinksEvent = OnElinksEventFn(decoratorFactoryFn);
